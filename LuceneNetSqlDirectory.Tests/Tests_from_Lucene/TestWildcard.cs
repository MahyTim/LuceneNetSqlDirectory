...
namespace LuceneNetSqlDirectory.Tests
{
    ...
    public class TestWildcard : LuceneTestCase
    {
        ...
        {
            var indexStore = GetIndexStore("field", new String[] { "nowildcard", "nowildcardx" });
            IndexSearcher searcher = new IndexSearcher(indexStore, true);
        ...
        {
            var indexStore = GetIndexStore("body", new String[] { "metal", "metals" });
            IndexSearcher searcher = new IndexSearcher(indexStore, true);
        ...
        {
            var indexStore = GetIndexStore("body", new System.String[] { "metal", "metals", "mXtals", "mXtXls" });
            IndexSearcher searcher = new IndexSearcher(indexStore, true);
        ...
        private SqlServerDirectory GetIndexStore(System.String field, System.String[] contents)
        {
            var indexStore = new SqlServerDirectory(Connection, new Options());
        ...
        public virtual void TestParsingAndSearching()
        {
            ...
            bool dbg = false;
            QueryParser qp = new QueryParser(Lucene.Net.Util.Version.LUCENE_CURRENT, field, new WhitespaceAnalyzer());
            ...
            // prepare the index
            var dir = new SqlServerDirectory(Connection,new Options());
